export const royalTemplate = {
    id: "royal",
    name: "Королівський",
    description: "Розкішний королівський стиль із кінематографічним відео, рукописним шрифтом та золотими акцентами",
    defaultColors: {
        primary: "#2A1220",
        text: "#F3E6CC",
        accent: "#C9A24B",
    ...
    thumbnail: {
        ...
        fontFaces: "@import url('https://fonts.googleapis.com/css2?family=Great+Vibes&display=swap'); .thumb-script-royal { font-family: \"Great Vibes\", cursive; }",
    },
    theme: {
