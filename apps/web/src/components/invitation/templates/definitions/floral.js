export const floralTemplate = {
    ...
    thumbnail: {
        ...
        fontFaces: "@import url('https://fonts.googleapis.com/css2?family=Allura&family=Italiana&display=swap'); .thumb-script-floral { font-family: \"Italiana\", serif; letter-spacing: 0.06em; }",
    },
    theme: {
        fontImports: "https://fonts.googleapis.com/css2?family=Allura&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;1,300;1,400&family=Italiana&display=swap",
        background: "#F4EFE6",
        surface: "#EDE6D6",
    ...
    sections: [
        {
            ...
            variant: "botanical",
            copy: {
                eyebrow: "Із радістю запрошуємо розділити з нами день, коли ми сказали одне одному «так»",
                connector: "та",
            },
        },
        {
