...
export const modernTemplate: TemplateDefinition = {
  ...
  thumbnail: {
    ...
    fontFaces:
      "@import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300&display=swap'); .thumb-script-modern { font-family: \"Cormorant Garamond\", serif; font-weight: 300; letter-spacing: -0.02em; }",
  },
  theme: {
    fontImports:
      "https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;500;600&family=Cormorant+Garamond:wght@300;400;500&display=swap",
    background: "#F4F7F1",
    surface: "#E8EFE4",
