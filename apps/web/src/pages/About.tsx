    ...
    <div className="min-h-screen font-geologica">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background text-center">
        <div className="container mx-auto max-w-3xl space-y-6">
          <p className="text-sm font-semibold uppercase tracking-widest text-primary">Beloved</p>
          <h1 className="text-3xl md:text-5xl font-bold leading-tight font-geologica text-foreground">
            Цифрові запрошення,<br />які гості запам'ятають
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Ми зробили конструктор, де за 10 хвилин можна створити красиве весільне запрошення — без дизайнера, без друку, без черг
          </p>
          <div className="pt-2">
            <Link to="/templates">
              <Button size="lg" className="text-xl px-10 py-6 shadow-elegant">
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-semibold text-center font-geologica mb-12">
            Порівняйте самі
          </h2>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="max-w-2xl mx-auto space-y-5 text-muted-foreground leading-relaxed text-center">
            <p>
              Beloved — Ukrainian-made продукт для пар, яким важлива кожна деталь свого весілля.
            </p>
            <p>
              Ми прибрали все зайве: жодних дизайнерів, жодного друку, жодних черг. Тільки конструктор, де ви самостійно створюєте запрошення та ділитесь ним зі своїми гостями в один клік.
            </p>
          </div>
        </div>
      </section>
